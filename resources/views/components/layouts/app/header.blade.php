...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    @if(session()->has('impersonating'))
        <div
            class="bg-yellow-500 dark:bg-yellow-600 text-black dark:text-white px-6 py-3 flex items-center justify-between shadow-lg">
            ...
            <form method="POST" action="{{ route('impersonate.stop') }}">
                ...
                <flux:button type="submit" variant="ghost" size="sm" icon="arrow-uturn-left"
                    class="!text-black dark:!text-white hover:!bg-yellow-600 dark:hover:!bg-yellow-700">
    ...
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:dropdown position="top" align="end">
            <flux:profile class="cursor-pointer" :avatar="auth()->user()->profile_photo_url"
